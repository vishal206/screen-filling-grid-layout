 ...
 *
 * Not wired up yet: `gap`, `onItemClick`, `onItemHover`, and re-solving on
 * resize. `maxRatioDeviation` is honoured by the solver when it shapes spans,
 * but the letterboxing it implies is not drawn.
 */
